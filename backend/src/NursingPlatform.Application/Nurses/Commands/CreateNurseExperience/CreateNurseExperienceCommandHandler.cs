...
public class CreateNurseExperienceCommandHandler : IRequestHandler<CreateNurseExperienceCommand, NurseExperienceDto>
{
    private readonly IApplicationDbContext _context;
    private readonly NurseRoleGuard _nurseRoleGuard;

    public CreateNurseExperienceCommandHandler(
    ...
    public async Task<NurseExperienceDto> Handle(CreateNurseExperienceCommand command, CancellationToken cancellationToken)
    {
        ...
        var experience = new NurseExperience
        {
            Id = Guid.NewGuid(),
        ...
        _context.NurseExperiences.Add(experience);
